...
import Login from "../../../Components/FrontComponent/LoginRegi/Login";
import SignUp from "../../../Components/FrontComponent/LoginRegi/SignUp";
    ...
    <div className=" bg-blue-50 min-h-screen">
      <div className="full-width-all pb-16">
        ...
        <div>
          {login && (
            <div className="">
              <Login signupArea={signupArea}></Login>
            </div>
          )}
          {signup && (
            <div className="">
