...
import spin from "../../../../assets/blue.gif";

const AllProductsPage = () => {
  // const [poroducts] = useProducts();
  ...
  useEffect(() => {
    setLoading(true);
    const url = `http://localhost:5000/api/v1/product/allproduct?search=${searchInput}&&page=${page}&&size=${size}&&sortDirection=asc&&Category=${category}`;
